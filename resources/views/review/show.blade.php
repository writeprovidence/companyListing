                            ...
                            <div class="review-card">
                                ...
                                <div class="entry-footer">
                                    ...
                                    <div>
                                        ...
                                        <a class="rewiew-btn feedback" data-value="yes" data-id="{{$review->company->slug}}" href="#" data-review="{{$review->slug}}"><i
                                                class="fa fa-thumbs-up"></i> Yes</a>
                                        <a class="rewiew-btn feedback" data-value="no" data-id="{{$review->company->slug}}" href="#" data-review="{{$review->slug}}"><i
