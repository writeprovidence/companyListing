    ...
    <section class="hero-section" style="background-image: url('{{asset('images/bg2.jpg')}}');">
        <div class="container">
            <div class="header-row">
                <div class="col">
                    <h1>{{$company->name}}</h1>
                    <span class="site-link"><a
                            href="{{route('redirect.company', $company->slug)}}">{{$company->website}} <i
                            ...
                            <div class="rating-block">
                                <div class="raiting-wrap">
                                    <svg class="star-full" width="2560" height="512" viewBox="0 0 2560 512" fill="none"
                                        ...
                                        <g clip-path="url('#r1')">
                                            <rect fill="#fbaf40" class="r1" x="0" y="0"
                                                width="{{$company->percentagerating}}%" height="100%">
                                            </rect>
                                        </g>
                                    </svg>
            ...
            <form id="review-form" action="{{route('store.review', $company->slug)}}" method="POST" class="review-form">
                ...
                <div class="form-row">
                    ...
                    <input id="title" type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}"
                        title="title" name="title" value="{{ old('title') }}" placeholder="Title *">
                </div>
                    ...
                    <div class="rate-box">
                        <div class="left-col">
                            <div class="rate-row">
                                ...
                                <fieldset class="rate">
                                    <input id="reliability-star5" type="radio" title="rate1" name="reliability"
                                        value="5" />
                                    <label for="reliability-star5" title="Excellent">5</label>
                                    <input id="reliability-star4" type="radio" title="rate1" name="reliability"
                                        value="4" />
                                    <label for="reliability-star4" title="Good">4</label>
                                    <input id="reliability-star3" type="radio" title="rate1" name="reliability"
                                        value="3" />
                                    <label for="reliability-star3" title="Satisfactory">3</label>
                                    <input id="reliability-star2" type="radio" title="rate1" name="reliability"
                                        value="2" />
                                    <label for="reliability-star2" title="Bad">2</label>
                                    <input id="reliability-star1" type="radio" title="rate1" name="reliability"
                                        value="1" />
                            ...
                            <div class="rate-row">
                                ...
                                <fieldset class="rate">
                                    <input id="user-friendly-star5" type="radio" title="rate3" name="user_friendly"
                                        value="5" />
                                    <label for="user-friendly-star5" title="Excellent">5</label>
                                    <input id="user-friendly-star4" type="radio" title="rate3" name="user_friendly"
                                        value="4" />
                                    <label for="user-friendly-star4" title="Good">4</label>
                                    <input id="user-friendly-star3" type="radio" title="rate3" name="user_friendly"
                                        value="3" />
                                    <label for="user-friendly-star3" title="Satisfactory">3</label>
                                    <input id="user-friendly-star2" type="radio" title="rate3" name="user_friendly"
                                        value="2" />
                                    <label for="user-friendly-star2" title="Bad">2</label>
                                    <input id="user-friendly-star1" type="radio" title="rate3" name="user_friendly"
                                        value="1" />
                    ...
                    <div class="col">
                        ...
                        <div class="form-row">
                            ...
                            <input id="socia-profiles" type="text"
                                class="form-control {{ $errors->has('social_profile') ? ' is-invalid' : '' }}"
                        ...
                        <div class="form-row">
                            ...
                            <input id="site" type="text"
                                class="form-control {{ $errors->has('site') ? ' is-invalid' : '' }}" name="site"
                                value="{{ old('site') }}" placeholder="Hosted Website">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-row">
                            ...
                            @endif
                            <input id="site" type="text"
                                class="form-control {{ $errors->has('previous_hosting') ? ' is-invalid' : '' }}"
                                name="previous_hosting" value="{{ old('previous_hosting') }}"
                                placeholder="Previous Hosting">
                        </div>
                    </div>
                </div>
