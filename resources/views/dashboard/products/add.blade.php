                    ...
                    <form action="{{route('store.products')}}" method="POST" class="dashboard-form">
                        ...
                        <div class="form-row">
                            ...
                            <input id="product_1_name" type="text"
                                class="form-control {{ $errors->has('product_1_name') ? ' is-invalid' : '' }}" name="product_1_name"
                                value="{{ old('product_1_name')}}" placeholder="Product Name *" >
                        ...
                        <div class="form-row">
                            ...
                            <input id="product_2_name" type="text"
                                class="form-control {{ $errors->has('product_2_name') ? ' is-invalid' : '' }}" name="product_2_name"
                                value="{{ old('product_2_name') }}" placeholder="Product Name *" >
                        ...
                        <div class="form-row">
                            ...
                            <input id="product_3_name" type="text"
                                class="form-control {{ $errors->has('product_3_name') ? ' is-invalid' : '' }}" name="product_3_name"
                                value="{{ old('product_3_name') }}" placeholder="Product Name *" >
                        ...
                        <div class="form-row">
                            ...
                            <input id="product_4_name" type="text"
                                class="form-control {{ $errors->has('product_4_name') ? ' is-invalid' : '' }}" name="product_4_name"
                                value="{{ old('product_4_name') }}" placeholder="Product Name *" >
                        ...
                        <div class="form-row">
                            ...
                            <input id="product_5_name" type="text"
                                class="form-control {{ $errors->has('product_5_name') ? ' is-invalid' : '' }}" name="product_5_name"
                                value="{{ old('product_5_name') }}" placeholder="Product Name *" >
