                    ...
                    <form action="{{route('store.company')}}" method="POST" class="dashboard-form"
                        ...
                        <div class="form-row">
                            ...
                            <input id="website" type="url"
                                ...
                                value="{{ old('website') }}" placeholder="Site (Https://)*">
                        </div>
                        <div class="shift-error">
                        ...
                        <div class="form-row">
                            ...
                            <input id="address_line1" type="text"
                                ...
                                name="address_line1" value="{{ old('address_line1') }}" placeholder="Address 1 *">
                        ...
                        <div class="form-row">
                            ...
                            <input id="address_line2" type="text"
                                ...
                                name="address_line2" value="{{ old('address_line2') }}" placeholder="Address 2 *">
