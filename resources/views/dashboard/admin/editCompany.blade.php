				...
				<div class="container">
					<div class="dashboard-wrap">
						<div class="dashboard-body">
							<form action="{{route('admin.updatecompany', $company->slug)}}" method="POST" class="dashboard-form">
                                @csrf
								...
								<div class="form-row">
									<label for="phone">Phone:</label>
                                        <input id="phone" type="text" class="form-control {{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone"
                                           value="{{ $company->phone }}" placeholder="Phone Number *" required>
								...
								<div class="form-row">
									<label for="address_line1">Address Line1:</label>
                                        <input id="address_line1" type="text" class="form-control {{ $errors->has('address_line1') ? ' is-invalid' : '' }}" name="address_line1"
                                            value="{{ $company->address_line1 }}" placeholder="Address 1 *">
								...
								<div class="form-row">
									<label for="address_line2">Address Line2:</label>
                                        <input id="address_line2" type="text" class="form-control {{ $errors->has('address_line2') ? ' is-invalid' : '' }}" name="address_line2"
                                            value="{{ $company->address_line2}}" placeholder="Address 2 *">
                                ...
                                <div class="form-row">
                                    ...
                                    <input id="country" type="text" class="form-control" value="{{ $company->country }}" disabled>
                                </div>
